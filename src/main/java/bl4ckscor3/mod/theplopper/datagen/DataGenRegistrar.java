...
@EventBusSubscriber(modid = ThePlopper.MOD_ID, bus = Bus.MOD)
public class DataGenRegistrar {
	...
	public static void onGatherData(GatherDataEvent event) {
		...
		generator.addProvider(true, new PackMetadataGenerator(output)
                .add(PackMetadataSection.TYPE, new PackMetadataSection(Component.literal("The Plopper resources & data"),
